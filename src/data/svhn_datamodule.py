"""SVHN DataModule for Active Learning with PyTorch Lightning."""
...
class SVHNDataModule(pl.LightningDataModule):
    """
    PyTorch Lightning DataModule for SVHN with Active Learning support.
    
    SVHN (Street View House Numbers) has 10 classes (digits 0-9)
    with 73,257 training images and 26,032 test images (32x32 RGB).
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.initial_labeled = al_config.get('initial_labeled', 7000)
        self.calibration_size = al_config.get('calibration_size', 7000)
        self.total_train_samples = al_config.get('total_train_samples', 73257)
    
    def prepare_data(self):
        """Download SVHN dataset."""
        datasets.SVHN(root=self.hparams.data_dir, split='train', download=True)
        datasets.SVHN(root=self.hparams.data_dir, split='test', download=True)
    ...
    def _build_transforms(self):
        ...
        # Note: No horizontal flip for SVHN (digits shouldn't be flipped)
    ...
    def _initialize_al_splits(self):
        ...
        print(f"SVHN AL splits initialized:")
